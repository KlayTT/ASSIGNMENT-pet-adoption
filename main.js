 ...
 */
      ...
      <button type="button" class="btn btn-dogs" id="dog">Dogs</button>
      <button type="button" class="btn btn-dinos" id="dino">Dinos</button>
      <button type="button" class="btn btn-pets" id="pets">All Pets</button>
      `;
    ...
    const petBuilder = (petsArray) => {
      ...
      petsArray.forEach( (pet) => {
        let petTypeClass = "";
        if (pet.type === "dog") {
          petTypeClass = "dog-pet-type";
    }
        if (pet.type === "cat") {
          petTypeClass = "cat-pet-type";
    }
        if (pet.type === "dino") {
          petTypeClass = "dino-pet-type";
    };
  ...
  renderToDom("#petContainer", domString);
      ...
      return petsArray.filter((petObject) => petObject.type === type);
    };
